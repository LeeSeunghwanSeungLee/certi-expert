public class RedBlackTree {
  ...
  public static void findNode (Node goal, Node node) {
  ...
  public static void inserNode (Node node) {
    if (root == null) {
      root = node;
      return;
    }
...
// 			right.left.parent = root;
  ...
  private static class Node {
    ...
    String getColor() { return color == RED ? "RED" : "BLACK"; }
    void setColor(int color) { this.color = color; }
    void setColor(String color {
      if (color.equals("BLACK") this.color = BLACK;
      else this.color = RED;
    }
  }
}
